diff --git a/ready_to_paste/custom_components/zendure_tempo/const.py b/ready_to_paste/custom_components/zendure_tempo/const.py
new file mode 100644
index 0000000000000000000000000000000000000000..d1dfa01b71afb5d78978fd567d5702018c7fe62e
--- /dev/null
+++ b/ready_to_paste/custom_components/zendure_tempo/const.py
@@ -0,0 +1,53 @@
+"""Constants for Zendure Tempo integration."""
+
+DOMAIN = "zendure_tempo"
+SERVICE_APPLY_MODE = "apply_mode"
+SERVICE_REGISTERED = "_service_registered"
+
+# Default values
